...
Redirect-filter bypasses. Useful standalone (phishing) and as a chain primitive for OAuth `redirect_uri` theft and SSRF allowlist bypass. See [[open-redirect]]; chains -> [[oauth-saml]], [[ssrf]].
